...
const {applicationImgUpload,myDocuments} = require('../../src/utils/multer')
...
const { generateReminders } = require("../../src/utils/reminderGenerator");
...
//     if (!setting) return res.status(400).send("No active webhook setting found");
