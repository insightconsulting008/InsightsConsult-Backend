...
router.post("/service",serviceImgUpload.single('photoUrl') ,async (req, res) => {
      try {
...
router.post("/service/:serviceId/input-fields", async (req, res) => {
      try {
        const { serviceId } = req.params;
    ...
    // =============================
    // 
router.post("/service/:serviceId/track-steps", async (req, res) => {
      try {
        const { serviceId } = req.params;
